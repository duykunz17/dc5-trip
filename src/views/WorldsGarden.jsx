                        ...
                        <div className="container">
                            <div className="row justify-content-center">
                                <div className="col-lg-8 col-md-9">
                                    <div className="destination_info">
                                        ...
                                        <p>Ở Việt Nam, một trong những Vườn Nhật đúng nghĩa đầu tiên đã được xây dựng tại Vinpearl Nha Trang. Đến đây, tín đồ văn hóa Phù Tang đễ dàng bắt gặp những khu vườn cảnh truyền thống với hoa cỏ, sỏi đá... mô phỏng sông ngòi, hồ nước hay núi đá trong tự nhiên.</p>
                                        <p>Ngoài ra những biểu tượng của văn hóa Nhật Bản như cổng trời Torii, ngôi nhà gỗ, cây cầu màu đỏ vắt ngang con suối với đàn cá Koi tung tăng bơi lội, những chậu cây bonsai mang vẻ đẹp thanh tịnh ... đều có ở Vinpearl Nha Trang.</p>
                                        <p><img src="../images/vinpearl/worlds-garden/vuonnhat2.jpg" className="d-block w-100" alt="..." /></p>
                            ...
                            <div className="row justify-content-center">
                                <div className="col-lg-8 col-md-9">
                                    <div className="destination_info">
                                        <h3>Vườn vạn hoa</h3>
                                         <p><img src="../images/vinpearl/worlds-garden/vuonvanhoa1.jpg" className="d-block w-100" alt="..." /></p>
                                    </div>
                                </div>
                            </div>
                            <div className="row justify-content-center">
